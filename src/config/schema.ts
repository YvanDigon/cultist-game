...
export const schema = z.object({
	...
	cultistsLeftLabel: z.string().default('Cultists left:'),
...
🏹 **Hunter**: Takes one soul with them when eliminated`),
	...
	narrationTone1: z.string().default('Dark'),
	narrationTone2: z.string().default('Humorous'),
	narrationTone3: z.string().default('Neutral'),
	narrationLengthShort: z.number().int().min(10).max(500).default(50),
	narrationLengthLong: z.number().int().min(10).max(500).default(120),
	narrationLengthShortLabel: z.string().default('Short (~{count} words)'),
	narrationLengthLongLabel: z.string().default('Long (~{count} words)'),
